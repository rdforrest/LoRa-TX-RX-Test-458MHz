...
***********************************************************************************************
  Revisions:
  Date        rev,    who      what
  17/06/2021  3.4     RDF      Added continuous Telemetry transmit to RX  help locate lost submarines
  4/07/2021   3.4     RDF      Added continuous Telemetry transmit to RX  help locate lost submarines. Tested in Nordenfelt sub.
  ...
  June 2021 Adding continuous Telemetry transmit to help locate lost submarines
