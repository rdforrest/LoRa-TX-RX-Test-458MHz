// This function decodes the ppm stream for individual pwm signals for the servos. From:
// https://forum.arduino.cc/t/ppm-read-and-move-servo-without-jitter/83915
void setup_timer1() {
  //WGM -> Fast PWM
  //Prescaler -> 1/8
